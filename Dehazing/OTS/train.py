...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/nvme0n1/cyn/datasets/OTS/reside-outdoor')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='/mnt/nvme0n1/cyn/iccv23/Dehazing/OTS/model_ots.pkl')
    parser.add_argument('--save_image', type=bool, default=False, choices=[True, False])

    args = parser.parse_args()
    args.model_save_dir = os.path.join('results/', 'focalnet', 'ots/')
